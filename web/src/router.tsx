...
const routeTree = rootRoute.addChildren([
  ...
  createRoute({ getParentRoute: () => rootRoute, path: '/projects/$projectId', component: ProjectDetailRoute, loader: load(projectsQuery, environmentsQuery, applicationsQuery, deploymentsQuery, serversQuery, containerRegistriesQuery, proxyRoutesQuery, githubRepositoriesQuery) }),
